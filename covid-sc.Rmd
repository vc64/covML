...
hist(log10(counts_per_cell+1),main='counts per cell',col='wheat', breaks = 50, xlim = c(1.95, 3.0))
hist(log10(genes_per_cell+1), main='genes per cell', col='wheat', breaks = 50, xlim = c(1.85, 3.75))
...
```{r}
seur <- CreateSeuratObject(counts = datalist$GSM4557327, project = "covidsc", min.cells = 5, min.features = 100)
